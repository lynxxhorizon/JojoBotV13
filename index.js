...
targetpc = "6283125871715";

gopay = "0822-1341-4687";
...
linkimg = "https://telegra.ph/file/fbe77e62bc6b415849626.jpg";

/*ITU YG DI ATAS LINK IMAGENYA DONASI DANA YA KAWAN*/

grupct = "https://chat.whatsapp.com/D7XwV14aXvFK0Sq3fvZwA7";

owner = "6283125871715";

nama_owner = "Adamm";

instagram = "adamalpha_";

yt = "https://youtube.com/channel/UCLuQIFtgFZd5QPAMIGIwJXw";
...
module.exports = syaa = async (syaa, mek) => {
  ...
  try {
    ...
    mess = {
      ...
      wait: `Tunggu Sebentar ya kak, sedang LynBotz Proses nihh!!`,
...
`;
        ...
        sendButImage(from, menu, "by @adamalpha_ ❤️", thumb, [
...
• Prefix : 「 ${prefixStatus ? "Multi Prefix" : "All Prefix"} 」
...
case "peraturan2":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `LynBotz merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x

Adapun ketentuan untuk memakai LynBotz :
